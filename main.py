...
if menu == "Home":
    ...
    st.markdown("Track your journey through the Digital Logic Lab curriculum.")
    ...
    <div style='background: linear-gradient(135deg, rgba(59, 130, 246, 0.1) 0%, rgba(139, 92, 246, 0.1) 100%); 
                ...
                margin-bottom: 2rem;'>
        <h2 style='margin-top: 0; color: #60a5fa; font-size: 2rem;'>Overall Statistics</h2>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style='margin: 2rem 0;'>
        <div style='display: flex; justify-content: space-between; margin-bottom: 0.5rem;'>
            <span style='color: #93c5fd; font-weight: 600; font-size: 1.1rem;'>Overall Completion</span>
    ...
    if progress == 1.0:
        st.balloons()
        st.success("🎉 CONGRATULATIONS! You have completed the entire Digital Logic Design Lab curriculum!")
    ...
    with col1:
        ...
        This application is designed to help you master Digital Electronics through hands-on simulation.
        
        #### 🛠️ How to Use This Lab
        
        1. **Select a Unit** from the sidebar navigation.
        2. **Choose an Experiment** using the tabs at the top of the unit page.
        3. **Read the Theory** to understand the core concepts.
        4. **Follow the Smart Tutor** in the right-hand panel. It will guide you step-by-step.
        5. **Interact with Controls** (switches, buttons) to modify circuit inputs.
        6. **Observe Results** in real-time on the oscilloscope and circuit diagrams.
